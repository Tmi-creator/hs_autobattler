...
SPELL_DB: Dict[str, Any] = {
    ...
    SpellIDs.LEAF_THROUGH_THE_PAGES: {
    ...
    SpellIDs.BARGAIN_BUNDLE: {
        "name": "Bargain Bundle",
        "tier": 5,
        "cost": 5,
        "effect": "DISCOVER",
        "params": {"tier": 5, "exact_tier": True},
    },
    SpellIDs.WAVE_OF_GOLD: {
        "name": "Wave of Gold",
        "tier": 5,
        "cost": 2,
        "effect": "BUFF_BOARD",
    ...
    SpellIDs.PERFECT_VISION: {
        "name": "Perfect Vision",
        "tier": 6,
        "cost": 2,
        "effect": "SET_STATS_20_20",
    },
}
